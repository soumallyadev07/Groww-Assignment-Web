...
function Table() {
    ...
    function handleCityChange(e) {
        const fetchNEWItems = async () => {
            const result = await axios(`https://vast-shore-74260.herokuapp.com/banks?city=${e.target.value}`)
    ...
    useEffect (() => {
        const fetchItems = async () => {
            const result = await axios(`https://vast-shore-74260.herokuapp.com/banks?city=${city}`)
    ...
    const [filterName, setFilterName] = useState("bank_name")
    ...
    return (
        <div className="container-fluid justify-content-center">
            <h1 className='p-2 text-center'>Find Your Bank</h1>
            
            <div className='p-2 d-flex justify-content-end'>
                <div className="p-1 mb-3">
                    <select id="Select" className="btn btn-secondary" onChange={handleCityChange} >
